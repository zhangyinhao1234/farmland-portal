    ...
    <Container>
      <template #header>
        <el-form ref="refForm" :inline="true" @keyup.enter="reacquireHandle()">
          ...
          <el-form-item>
            <el-input v-model="form.acode" placeholder="服务编码" clearable />
          </el-form-item>
  
          <el-form-item>
            <el-button v-repeat @click="reacquireHandle()">搜索</el-button>
            <el-button v-repeat @click="clearJson(form), reacquireHandle()">重置</el-button>
            <el-button v-permission="'data:appuser:create'" type="primary" @click="addEditHandle()">新增</el-button>
        ...
        <el-table
          ...
          <el-table-column
            ...
            <template v-slot="{ row }">
              ...
              <el-button
                v-permission="'data:appuser:delete'"
                type="danger"
                link
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onBeforeMount(() => {
        ...
        // console.info("接收到上一个页面的参数:"+JSON.stringify(route.query))
        //router.params
        getList()
      })
